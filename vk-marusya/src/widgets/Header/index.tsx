...
export const Header = () => {
  return (
    <header className={styles["header"]}>
      <Link href="/" className={`${styles["header__logo"]} ${styles["link"]}`}>
        <Image src={"/icons/logo.svg"} width={18} height={18} alt="Logo" />
        <Image src={"/icons/brand.svg"} width={56} height={12} alt="Logo" />
      </Link>
